...
const PaymentInput = ({ onChange, value, defaultValue, className, maxLength = 19, label: label$1, hint, ...props }) => {
    const [cardNumber, setCardNumber] = useControlledState.$458b0a5536c1a7cf$export$40bfa8c7b0832715(value, defaultValue || '', (value) => {
        // Remove all non-numeric characters
        value = value.replace(/\D/g, '');
        onChange === null || onChange === void 0 ? void 0 : onChange(value || '');
    });
    const card = detectCardType(cardNumber);
    return (jsxRuntime.jsx(input.TextField, { "aria-label": !label$1 ? props === null || props === void 0 ? void 0 : props.placeholder : undefined, ...props, className: className, inputMode: "numeric", maxLength: maxLength, value: formatCardNumber(cardNumber), onChange: setCardNumber, children: ({ isDisabled, isInvalid, isRequired }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label$1 && jsxRuntime.jsx(label.Label, { isRequired: isRequired, children: label$1 }), jsxRuntime.jsx(input.InputBase, { ...props, isDisabled: isDisabled, isInvalid: isInvalid, icon: card.icon, inputClassName: "pl-13", iconClassName: "left-2.5 h-6 w-8.5" }), hint && jsxRuntime.jsx(hintText.HintText, { isInvalid: isInvalid, children: hint })] })) }));
};
PaymentInput.displayName = 'PaymentInput';

function InputCardNumberField({ label, hint, isInvalid, isRequired, tooltip, description, id = '', fieldSize = 'md', labelPosition = 'left', ...props }) {
    return (jsxRuntime.jsx(FieldWrapper.FieldWrapper, { id: id, label: label, hint: hint, isInvalid: isInvalid, isRequired: isRequired, tooltip: tooltip, description: description, fieldSize: fieldSize, labelPosition: labelPosition, children: jsxRuntime.jsx(PaymentInput, { isInvalid: isInvalid, ...props }) }));
}

function InputEmailField({ label, hint, isInvalid, isRequired, tooltip, description, id = '', fieldSize = 'md', labelPosition = 'left', ...props }) {
    return (jsxRuntime.jsx(FieldWrapper.FieldWrapper, { id: id, label: label, hint: hint, isInvalid: isInvalid, isRequired: isRequired, tooltip: tooltip, description: description, fieldSize: fieldSize, labelPosition: labelPosition, children: jsxRuntime.jsx(input.Input, { ...props, isInvalid: isInvalid, type: "email", icon: icons.Mail01 }) }));
}

function InputPhoneNumberField({ type: _type, placeholder, shortcut, countries = [{ label: 'US', value: 'US' }], label, hint, isInvalid, isRequired, tooltip, description, id = '', fieldSize = 'md', labelPosition = 'left', ...restProps }) {
    return (jsxRuntime.jsx(FieldWrapper.FieldWrapper, { id: id, label: label, hint: hint, isInvalid: isInvalid, isRequired: isRequired, tooltip: tooltip, description: description, fieldSize: fieldSize, labelPosition: labelPosition, children: jsxRuntime.jsx(inputGroup.InputGroup, { leadingAddon: jsxRuntime.jsx(selectNative.NativeSelect, { options: countries, defaultValue: "US" }), ...restProps, children: jsxRuntime.jsx(input.InputBase, { type: "tel", inputMode: "tel", placeholder: placeholder, shortcut: shortcut, isInvalid: isInvalid }) }) }));
}

function InputWebsiteField({ placeholder, shortcut, label, hint, isInvalid, isRequired, tooltip, description, id = '', labelPosition = 'left', ...restProps }) {
    return (jsxRuntime.jsx(FieldWrapper.FieldWrapper, { id: id, label: label, hint: hint, isInvalid: isInvalid, isRequired: isRequired, tooltip: tooltip, description: description, labelPosition: labelPosition, children: jsxRuntime.jsx(inputGroup.InputGroup, { leadingAddon: jsxRuntime.jsx(inputGroup.InputGroup.Prefix, { children: "https://" }), ...restProps, children: jsxRuntime.jsx(input.InputBase, { type: "url", placeholder: placeholder, shortcut: shortcut, isInvalid: isInvalid }) }) }));
}

exports.Input = InputField.Input;
exports.InputField = InputField.InputField;
exports.InputSearchField = InputSearchField.InputSearchField;
exports.InputAmountField = InputAmountField;
exports.InputCardNumberField = InputCardNumberField;
exports.InputEmailField = InputEmailField;
exports.InputGroupField = InputGroupField;
exports.InputPhoneNumberField = InputPhoneNumberField;
exports.InputWebsiteField = InputWebsiteField;
