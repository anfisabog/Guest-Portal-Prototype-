export { a as Input, I as InputField } from '../_shared/InputField-8Udd41T0.esm.js';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { a as InputBase, T as TextField, I as Input } from '../_shared/input-BOpcbRQD.esm.js';
...
import { H as HintText } from '../_shared/hint-text-Ck8Vj_nN.esm.js';
import { L as Label } from '../_shared/label-pgzo6IFb.esm.js';
import { Mail01 } from '@untitledui/icons';
export { I as InputSearchField } from '../_shared/InputSearchField-CTy3JMq7.esm.js';
import 'react';
...
function InputGroupField({ type, icon, placeholder, tooltip, shortcut, wrapperClassName, tooltipClassName, inputClassName, iconClassName, ...restProps }) {
    return (jsx(InputGroup, { ...restProps, children: jsx(InputBase, { wrapperClassName: wrapperClassName, tooltipClassName: tooltipClassName, inputClassName: inputClassName, iconClassName: iconClassName, type: type, icon: icon, placeholder: placeholder, tooltip: tooltip, shortcut: shortcut }) }));
}
...
function InputAmountField({ placeholder, shortcut, currencies = [{ value: 'USD', label: 'USD' }], 'data-id': dataId, label, hint, isInvalid, isRequired, tooltip, description, id = '', fieldSize = 'md', labelPosition = 'left', ...restProps }) {
    return (jsx(FieldWrapper, { id: id, label: label, hint: hint, isInvalid: isInvalid, isRequired: isRequired, tooltip: tooltip, description: description, fieldSize: fieldSize, labelPosition: labelPosition, children: jsx(InputGroup, { trailingAddon: jsx(NativeSelect, { options: currencies, defaultValue: "USD" }), ...restProps, children: jsx(InputBase, { placeholder: placeholder, shortcut: shortcut, "data-id": dataId, isInvalid: isInvalid }) }) }));
}

const AmexIcon = (props) => {
    return (jsxs("svg", { width: "34", height: "24", viewBox: "0 0 34 24", fill: "none", ...props, children: [jsx("path", { d: "M0 4C0 1.79086 1.79086 0 4 0H30C32.2091 0 34 1.79086 34 4V20C34 22.2091 32.2091 24 30 24H4C1.79086 24 0 22.2091 0 20V4Z", fill: "#1F72CD" }), jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M6.09517 8.5L2.91406 15.7467H6.7223L7.19441 14.5913H8.27355L8.74566 15.7467H12.9375V14.8649L13.311 15.7467H15.4793L15.8528 14.8462V15.7467H24.5706L25.6307 14.6213L26.6232 15.7467L31.1009 15.7561L27.9097 12.1436L31.1009 8.5H26.6927L25.6608 9.60463L24.6995 8.5H15.2156L14.4013 10.3704L13.5678 8.5H9.7675V9.35186L9.34474 8.5H6.09517ZM6.83205 9.52905H8.68836L10.7984 14.4431V9.52905H12.8319L14.4617 13.0524L15.9637 9.52905H17.987V14.7291H16.7559L16.7458 10.6544L14.9509 14.7291H13.8495L12.0446 10.6544V14.7291H9.51179L9.03162 13.5633H6.43745L5.95827 14.728H4.60123L6.83205 9.52905ZM24.1196 9.52905H19.1134V14.726H24.0421L25.6307 13.0036L27.1618 14.726H28.7624L26.436 12.1426L28.7624 9.52905H27.2313L25.6507 11.2316L24.1196 9.52905ZM7.73508 10.4089L6.8804 12.4856H8.58876L7.73508 10.4089ZM20.3497 11.555V10.6057V10.6048H23.4734L24.8364 12.1229L23.413 13.6493H20.3497V12.613H23.0808V11.555H20.3497Z", fill: "white" })] }));
};

const DiscoverIcon = (props) => {
    return (jsxs("svg", { width: "34", height: "24", viewBox: "0 0 34 24", fill: "none", ...props, children: [jsx("path", { d: "M0.5 4C0.5 2.067 2.067 0.5 4 0.5H30C31.933 0.5 33.5 2.067 33.5 4V20C33.5 21.933 31.933 23.5 30 23.5H4C2.067 23.5 0.5 21.933 0.5 20V4Z", fill: "white" }), jsx("path", { d: "M0.5 4C0.5 2.067 2.067 0.5 4 0.5H30C31.933 0.5 33.5 2.067 33.5 4V20C33.5 21.933 31.933 23.5 30 23.5H4C2.067 23.5 0.5 21.933 0.5 20V4Z", className: "stroke-border-secondary", strokeWidth: "0.75" }), jsx("path", { d: "M14 23L33 17.25V20C33 21.6569 31.6569 23 30 23H14Z", fill: "#FD6020" }), jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M29.3937 9.11084C30.439 9.11084 31.0139 9.59438 31.0139 10.5077C31.0662 11.2062 30.5958 11.7972 29.9686 11.9046L31.3797 13.8925H30.2822L29.0801 11.9584H28.9756V13.8925H28.0871V9.11084H29.3937ZM28.9756 11.3137H29.2369C29.8118 11.3137 30.0731 11.045 30.0731 10.5615C30.0731 10.1317 29.8118 9.86304 29.2369 9.86304H28.9756V11.3137ZM25.0034 13.8925H27.5122V13.0866H25.8919V11.7972H27.4599V10.9913H25.8919V9.91674H27.5122V9.11084H25.0034V13.8925ZM22.3902 12.3345L21.1881 9.11084H20.2474L22.1812 14H22.6515L24.5853 9.11084H23.6446L22.3902 12.3345ZM11.7805 11.5286C11.7805 12.8717 12.8258 14 14.1324 14C14.5505 14 14.9164 13.8925 15.2822 13.7314V12.6568C15.0209 12.9792 14.655 13.1941 14.2369 13.1941C13.4007 13.1941 12.7212 12.5494 12.7212 11.6897V11.5823C12.669 10.7227 13.3484 9.97048 14.1847 9.91675C14.6028 9.91675 15.0209 10.1317 15.2822 10.454V9.37948C14.9686 9.16458 14.5505 9.11085 14.1847 9.11085C12.8258 9.0034 11.7805 10.1317 11.7805 11.5286ZM10.1603 10.9376C9.63762 10.7227 9.48082 10.6152 9.48082 10.3466C9.53309 10.0242 9.79441 9.75557 10.108 9.8093C10.3693 9.8093 10.6306 9.97048 10.8397 10.1854L11.3101 9.54066C10.9442 9.2183 10.4739 9.00339 10.0035 9.00339C9.27176 8.94967 8.64459 9.54066 8.59232 10.2928V10.3466C8.59232 10.9913 8.85365 11.3674 9.68988 11.636C9.89894 11.6897 10.108 11.7972 10.3171 11.9046C10.4739 12.0121 10.5784 12.1733 10.5784 12.3882C10.5784 12.7643 10.2648 13.0866 9.95121 13.0866H9.89894C9.48082 13.0866 9.11497 12.818 8.95818 12.4419L8.38326 13.0329C8.69685 13.6239 9.32403 13.9463 9.95121 13.9463C10.7874 14 11.4669 13.3553 11.5191 12.4956V12.3345C11.4669 11.6897 11.2056 11.3674 10.1603 10.9376ZM7.12892 13.8925H8.01742V9.11084H7.12892V13.8925ZM3 9.11086H4.30662H4.56794C5.8223 9.16458 6.81532 10.2391 6.76306 11.5286C6.76306 12.227 6.44947 12.8717 5.92682 13.3553C5.45644 13.7314 4.88153 13.9463 4.30662 13.8926H3V9.11086ZM4.14983 13.0866C4.56794 13.1404 5.03833 12.9792 5.35191 12.7105C5.6655 12.3882 5.8223 11.9584 5.8223 11.4748C5.8223 11.045 5.6655 10.6152 5.35191 10.2928C5.03833 10.0242 4.56794 9.86302 4.14983 9.91674H3.8885V13.0866H4.14983Z", fill: "black" }), jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M17.9481 9C16.6415 9 15.5439 10.0745 15.5439 11.4714C15.5439 12.8146 16.5892 13.9429 17.9481 13.9966C19.307 14.0503 20.3523 12.9221 20.4046 11.5252C20.3523 10.1283 19.307 9 17.9481 9V9Z", fill: "#FD6020" })] }));
};

const MastercardIcon = (props) => {
    return (jsxs("svg", { width: "34", height: "24", viewBox: "0 0 34 24", fill: "none", ...props, children: [jsx("path", { d: "M0.5 4C0.5 2.067 2.067 0.5 4 0.5H30C31.933 0.5 33.5 2.067 33.5 4V20C33.5 21.933 31.933 23.5 30 23.5H4C2.067 23.5 0.5 21.933 0.5 20V4Z", fill: "white" }), jsx("path", { d: "M0.5 4C0.5 2.067 2.067 0.5 4 0.5H30C31.933 0.5 33.5 2.067 33.5 4V20C33.5 21.933 31.933 23.5 30 23.5H4C2.067 23.5 0.5 21.933 0.5 20V4Z", className: "stroke-border-secondary", strokeWidth: "0.75" }), jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M17.179 16.8294C15.9949 17.8275 14.459 18.43 12.7807 18.43C9.03582 18.43 6 15.4303 6 11.73C6 8.02966 9.03582 5.02997 12.7807 5.02997C14.459 5.02997 15.9949 5.63247 17.179 6.63051C18.363 5.63247 19.8989 5.02997 21.5773 5.02997C25.3221 5.02997 28.358 8.02966 28.358 11.73C28.358 15.4303 25.3221 18.43 21.5773 18.43C19.8989 18.43 18.363 17.8275 17.179 16.8294Z", fill: "#ED0006" }), jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M17.1787 16.8294C18.6366 15.6005 19.5611 13.7719 19.5611 11.73C19.5611 9.68801 18.6366 7.85941 17.1787 6.63051C18.3628 5.63247 19.8987 5.02997 21.577 5.02997C25.3219 5.02997 28.3577 8.02966 28.3577 11.73C28.3577 15.4303 25.3219 18.43 21.577 18.43C19.8987 18.43 18.3628 17.8275 17.1787 16.8294Z", fill: "#F9A000" }), jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M17.1793 16.8294C18.6372 15.6005 19.5616 13.7719 19.5616 11.73C19.5616 9.68805 18.6372 7.85946 17.1793 6.63055C15.7213 7.85946 14.7969 9.68805 14.7969 11.73C14.7969 13.7719 15.7213 15.6005 17.1793 16.8294Z", fill: "#FF5E00" })] }));
};
...
const PaymentInput = ({ onChange, value, defaultValue, className, maxLength = 19, label, hint, ...props }) => {
    const [cardNumber, setCardNumber] = $458b0a5536c1a7cf$export$40bfa8c7b0832715(value, defaultValue || '', (value) => {
        // Remove all non-numeric characters
        value = value.replace(/\D/g, '');
        onChange === null || onChange === void 0 ? void 0 : onChange(value || '');
    });
    const card = detectCardType(cardNumber);
    return (jsx(TextField, { "aria-label": !label ? props === null || props === void 0 ? void 0 : props.placeholder : undefined, ...props, className: className, inputMode: "numeric", maxLength: maxLength, value: formatCardNumber(cardNumber), onChange: setCardNumber, children: ({ isDisabled, isInvalid, isRequired }) => (jsxs(Fragment, { children: [label && jsx(Label, { isRequired: isRequired, children: label }), jsx(InputBase, { ...props, isDisabled: isDisabled, isInvalid: isInvalid, icon: card.icon, inputClassName: "pl-13", iconClassName: "left-2.5 h-6 w-8.5" }), hint && jsx(HintText, { isInvalid: isInvalid, children: hint })] })) }));
};
...
function InputCardNumberField({ label, hint, isInvalid, isRequired, tooltip, description, id = '', fieldSize = 'md', labelPosition = 'left', ...props }) {
    return (jsx(FieldWrapper, { id: id, label: label, hint: hint, isInvalid: isInvalid, isRequired: isRequired, tooltip: tooltip, description: description, fieldSize: fieldSize, labelPosition: labelPosition, children: jsx(PaymentInput, { isInvalid: isInvalid, ...props }) }));
}

function InputEmailField({ label, hint, isInvalid, isRequired, tooltip, description, id = '', fieldSize = 'md', labelPosition = 'left', ...props }) {
    return (jsx(FieldWrapper, { id: id, label: label, hint: hint, isInvalid: isInvalid, isRequired: isRequired, tooltip: tooltip, description: description, fieldSize: fieldSize, labelPosition: labelPosition, children: jsx(Input, { ...props, isInvalid: isInvalid, type: "email", icon: Mail01 }) }));
}
...
function InputPhoneNumberField({ type: _type, placeholder, shortcut, countries = [{ label: 'US', value: 'US' }], label, hint, isInvalid, isRequired, tooltip, description, id = '', fieldSize = 'md', labelPosition = 'left', ...restProps }) {
    return (jsx(FieldWrapper, { id: id, label: label, hint: hint, isInvalid: isInvalid, isRequired: isRequired, tooltip: tooltip, description: description, fieldSize: fieldSize, labelPosition: labelPosition, children: jsx(InputGroup, { leadingAddon: jsx(NativeSelect, { options: countries, defaultValue: "US" }), ...restProps, children: jsx(InputBase, { type: "tel", inputMode: "tel", placeholder: placeholder, shortcut: shortcut, isInvalid: isInvalid }) }) }));
}
...
function InputWebsiteField({ placeholder, shortcut, label, hint, isInvalid, isRequired, tooltip, description, id = '', labelPosition = 'left', ...restProps }) {
    return (jsx(FieldWrapper, { id: id, label: label, hint: hint, isInvalid: isInvalid, isRequired: isRequired, tooltip: tooltip, description: description, labelPosition: labelPosition, children: jsx(InputGroup, { leadingAddon: jsx(InputGroup.Prefix, { children: "https://" }), ...restProps, children: jsx(InputBase, { type: "url", placeholder: placeholder, shortcut: shortcut, isInvalid: isInvalid }) }) }));
}

export { InputAmountField, InputCardNumberField, InputEmailField, InputGroupField, InputPhoneNumberField, InputWebsiteField };
