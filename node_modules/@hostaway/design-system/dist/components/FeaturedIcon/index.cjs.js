...
var isReactComponent = require('../_shared/is-react-component-DkG20B86.cjs.js');
...
function FeaturedIcon({ size = 'md', color = 'brand', theme = 'light', icon: Icon, children, className, ...otherProps }) {
    return (jsxRuntime.jsxs("div", { ...otherProps, "data-featured-icon": true, className: cx.cx('relative flex shrink-0 items-center justify-center', iconsSizes[size], styles[theme].base, styles[theme].sizes[size], styles[theme].colors[color], className), children: [isReactComponent.isReactComponent(Icon) && (jsxRuntime.jsx(Icon, { "data-icon": true, className: "z-1" })), h.isValidElement(Icon) && jsxRuntime.jsx("div", { className: "z-1", children: Icon }), children] }));
}
