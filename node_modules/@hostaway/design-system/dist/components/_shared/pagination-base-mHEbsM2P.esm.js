...
import { createContext, useState, useCallback, useEffect, useContext, isValidElement, cloneElement } from 'react';
...
const PaginationRoot = ({ total, siblingCount = 1, page, onPageChange, children, style, className, }) => {
    ...
    return (jsx(PaginationContext.Provider, { value: paginationContextValue, children: jsx("nav", { "aria-label": "Pagination Navigation", style: style, className: className, children: children }) }));
};
/**
...
const Trigger = ({ children, style, className, asChild = false, direction, ariaLabel, }) => {
    ...
    if (typeof children === 'function') {
        return jsx(Fragment, { children: children({ isDisabled, onClick: handleClick }) });
    }
    ...
    return (jsx("button", { "aria-label": ariaLabel || defaultAriaLabel, onClick: handleClick, disabled: isDisabled, style: style, className: computedClassName, children: children }));
};
const PaginationPrevTrigger = (props) => (jsx(Trigger, { ...props, direction: "prev" }));
const PaginationNextTrigger = (props) => (jsx(Trigger, { ...props, direction: "next" }));
const PaginationItem = ({ value, isCurrent, children, style, className, ariaLabel, asChild = false, }) => {
    ...
    return (jsx("button", { onClick: handleClick, style: style, className: computedClassName, "aria-current": isCurrent ? 'page' : undefined, "aria-label": ariaLabel || `Page ${value}`, role: "listitem", children: children }));
};
const PaginationEllipsis = ({ children, style, className, }) => {
    const computedClassName = typeof className === 'function' ? className() : className;
    return (jsx("span", { style: style, className: computedClassName, "aria-hidden": "true", children: children }));
};
const PaginationContextComponent = ({ children, }) => {
    ...
    return jsx(Fragment, { children: children(context) });
};
const Pagination = {
    Root: PaginationRoot,
...
//# sourceMappingURL=pagination-base-mHEbsM2P.esm.js.map
