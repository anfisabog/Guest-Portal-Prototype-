@theme {
    --max-width-desktop: var(--spacing-320);
    --padding-desktop: var(--spacing-8);
    --padding-mobile: var(--spacing-4);
    ...
    --font-size-text-display-xs: 24px;
    --font-size-text-display-sm: 30px;
    --font-size-text-display-md: 36px;
    --font-size-text-display-lg: 48px;
    --font-size-text-display-xl: 60px;
    --font-size-text-display-2xl: 72px;
    ...
    --color-shadow-sm_01: rgba(10, 13, 18, 0.1);
    --color-shadow-sm_02: rgba(10, 13, 18, 0.1);
    --color-shadow-md_01: rgba(10, 13, 18, 0.1);
    --color-shadow-md_02: rgba(10, 13, 18, 0.06);
    --color-shadow-lg_01: rgba(10, 13, 18, 0.08);
    --color-shadow-lg_02: rgba(10, 13, 18, 0.03);
    --color-shadow-lg_03: rgba(10, 13, 18, 0.04);
    --color-shadow-xl_01: rgba(10, 13, 18, 0.08);
    --color-shadow-xl_02: rgba(10, 13, 18, 0.03);
    --color-shadow-xl_03: rgba(10, 13, 18, 0.04);
    --color-shadow-2xl_01: rgba(10, 13, 18, 0.18);
    --color-shadow-2xl_02: rgba(10, 13, 18, 0.04);
    --color-shadow-3xl_01: rgba(10, 13, 18, 0.14);
    --color-shadow-3xl_02: rgba(10, 13, 18, 0.04);
    --color-shadow-skeumorphic-inner: rgba(10, 13, 18, 0.05);
    --color-shadow-skeumorphic-inner-border: rgba(10, 13, 18, 0.18);

    --shadow-xs: 0px 1px 2px 0px var(--color-shadow-xs);
    --shadow-sm: 0px 1px 3px 0px var(--color-shadow-sm_01), 0px 1px 2px -1px var(--color-shadow-sm_02);
    --shadow-md: 0px 4px 6px -1px var(--color-shadow-md_01), 0px 2px 4px -2px var(--color-shadow-md_02);
    --shadow-lg: 0px 12px 16px -4px var(--color-shadow-lg_01), 0px 4px 6px -2px var(--color-shadow-lg_02), 0px 2px 2px -1px var(--color-shadow-lg_03);
    --shadow-xl: 0px 20px 24px -4px var(--color-shadow-xl_01), 0px 8px 8px -4px var(--color-shadow-xl_02), 0px 3px 3px -1.5px var(--color-shadow-xl_03);
    --shadow-2xl: 0px 24px 48px -12px var(--color-shadow-2xl_01), 0px 4px 4px -2px var(--color-shadow-2xl_02);
    --shadow-3xl: 0px 32px 64px -12px var(--color-shadow-3xl_01), 0px 5px 5px -2.5px var(--color-shadow-3xl_02);
    ...
    --color-alpha-white-80: rgba(255, 255, 255, 0.800);
    --color-alpha-white-70: rgba(255, 255, 255, 0.702);
    --color-alpha-white-60: rgba(255, 255, 255, 0.600);
    --color-alpha-white-50: rgba(255, 255, 255, 0.502);
    --color-alpha-white-40: rgba(255, 255, 255, 0.400);
    --color-alpha-white-30: rgba(255, 255, 255, 0.302);
    --color-alpha-white-20: rgba(255, 255, 255, 0.200);
    --color-alpha-white-10: rgba(255, 255, 255, 0.102);
    --color-alpha-black-10: rgba(0, 0, 0, 0.102);
    --color-alpha-black-20: rgba(0, 0, 0, 0.200);
    --color-alpha-black-30: rgba(0, 0, 0, 0.302);
    --color-alpha-black-40: rgba(0, 0, 0, 0.400);
    --color-alpha-black-50: rgba(0, 0, 0, 0.502);
    --color-alpha-black-60: rgba(0, 0, 0, 0.600);
    --color-alpha-black-70: rgba(0, 0, 0, 0.702);
    --color-alpha-black-80: rgba(0, 0, 0, 0.800);
    --color-alpha-black-90: rgba(0, 0, 0, 0.902);
    --color-alpha-black-100: rgb(0, 0, 0);
    --color-alpha-white-100: rgb(255, 255, 255);


    /* Primary Colors */
    --color-base-white: rgb(255, 255, 255);
    --color-base-black: rgb(0, 0, 0);
    --color-base-transparent: rgba(255, 255, 255, 0.000);
    ...
    --color-hostaway-primary-25: rgba(255, 251, 249, 1);
    --color-hostaway-primary-50: rgba(255, 247, 243, 1);
    --color-hostaway-primary-100: rgba(255, 233, 222, 1);
    --color-hostaway-primary-200: rgba(255, 233, 222, 1);
    --color-hostaway-primary-300: rgba(255, 176, 122, 1);
    --color-hostaway-primary-400: rgba(254, 146, 77, 1);
    --color-hostaway-primary-500: rgba(253, 99, 0, 1);
    --color-hostaway-primary-600: rgba(202, 79, 0, 1);
    --color-hostaway-primary-700: rgba(177, 69, 0, 1);
    --color-hostaway-primary-800: rgba(127, 50, 0, 1);
    --color-hostaway-primary-900: rgba(98, 40, 0, 1);
    --color-hostaway-primary-950: rgba(59, 24, 0, 1);

    --color-hostaway-secondary-25: rgba(249, 253, 253, 1);
    --color-hostaway-secondary-50: rgba(242, 252, 251, 1);
    --color-hostaway-secondary-100: rgba(217, 247, 247, 1);
    --color-hostaway-secondary-200: rgba(178, 239, 238, 1);
    --color-hostaway-secondary-300: rgba(157, 230, 228, 1);
    --color-hostaway-secondary-400: rgba(102, 211, 209, 1);
    --color-hostaway-secondary-500: rgba(0, 181, 178, 1);
    --color-hostaway-secondary-600: rgba(51, 156, 153, 1);
    --color-hostaway-secondary-700: rgba(0, 131, 128, 1);
    --color-hostaway-secondary-800: rgba(0, 98, 96, 1);
    --color-hostaway-secondary-900: rgba(0, 78, 77, 1);
    --color-hostaway-secondary-950: rgba(0, 47, 46, 1);
    ...
    --color-orange-100: rgb(253, 237, 215);
    ...
    --color-utility-brand-50: var(--color-hostaway-secondary-50);
    --color-utility-brand-100: var(--color-hostaway-secondary-100);
    --color-utility-brand-200: var(--color-hostaway-secondary-200);
    --color-utility-brand-400: var(--color-hostaway-secondary-400);
    --color-utility-brand-500: var(--color-hostaway-secondary-500);
    --color-utility-brand-600: var(--color-hostaway-secondary-600);
    --color-utility-brand-700: var(--color-hostaway-secondary-700);

    --color-utility-brand-50_alt: var(--color-hostaway-secondary-50);
    --color-utility-brand-100_alt: var(--color-hostaway-secondary-100);
    --color-utility-brand-200_alt: var(--color-hostaway-secondary-200);
    --color-utility-brand-300: var(--color-hostaway-secondary-300);
    --color-utility-brand-300_alt: var(--color-hostaway-secondary-300);
    --color-utility-brand-400_alt: var(--color-hostaway-secondary-400);
    --color-utility-brand-500_alt: var(--color-hostaway-secondary-500);
    --color-utility-brand-600_alt: var(--color-hostaway-secondary-600);
    --color-utility-brand-700_alt: var(--color-hostaway-secondary-700);
    --color-utility-brand-800: var(--color-hostaway-secondary-800);
    --color-utility-brand-800_alt: var(--color-hostaway-secondary-800);
    --color-utility-brand-900: var(--color-hostaway-secondary-900);
    --color-utility-brand-900_alt: var(--color-hostaway-secondary-900);
    ...
    --text-color-primary_on-brand: var(--color-base-white);
    --text-color-secondary: var(--color-gray-700);
    --text-color-secondary_hover: var(--color-gray-800);
    --text-color-secondary_on-brand: var(--color-hostaway-secondary-200);
    --text-color-tertiary: var(--color-gray-600);
    --text-color-tertiary_hover: var(--color-gray-600);
    --text-color-tertiary_on-brand: var(--color-hostaway-secondary-200);
    --text-color-quaternary: var(--color-gray-500);
    --text-color-quaternary_on-brand: var(--color-hostaway-secondary-300);
    --text-color-white: var(--color-base-white);
    --text-color-disabled: var(--color-gray-500);
    --text-color-placeholder: var(--color-gray-500);
    --text-color-placeholder_subtle: var(--color-gray-300);
    --text-color-brand-primary: var(--color-hostaway-secondary-900);
    --text-color-brand-secondary: var(--color-hostaway-secondary-700);
    --text-color-brand-secondary_hover: var(--color-hostaway-secondary-800);
    --text-color-brand-tertiary: var(--color-hostaway-secondary-600);
    --text-color-brand-tertiary_alt: var(--color-hostaway-secondary-600);
    --text-color-error-primary: var(--color-error-600);
    --text-color-error-primary_hover: var(--color-error-700);
    ...
    --color-border-brand: var(--color-hostaway-secondary-500);
    ...
    --color-fg-brand-primary: var(--color-gray-900);
    --color-fg-brand-primary_alt: var(--color-fg-brand-primary);
    --color-fg-brand-secondary: var(--color-gray-500);
    --color-fg-brand-secondary_alt: var(--color-fg-brand-secondary);
    --color-fg-brand-secondary_hover: var(--color-gray-600);
    ...
    --background-color-primary_alt: var(--color-base-white);
    --background-color-primary_hover: var(--color-gray-50);
    --background-color-primary-solid: var(--color-gray-950);
    --background-color-secondary: var(--color-gray-50);
    --background-color-secondary_alt: var(--color-gray-50);
    --background-color-secondary_hover: var(--color-gray-100);
    --background-color-secondary_subtle: var(--color-gray-25);
    --background-color-secondary-solid: var(--color-gray-600);
    --background-color-tertiary: var(--color-gray-100);
    --background-color-quaternary: var(--color-gray-200);
    --background-color-active: var(--color-gray-50);
    --background-color-disabled: var(--color-gray-100);
    --background-color-disabled_subtle: var(--color-gray-50);
    --background-color-overlay: var(--color-gray-950);
    --background-color-brand-primary: var(--color-hostaway-secondary-50);
    --background-color-brand-primary_alt: var(--color-hostaway-secondary-50);
    --background-color-brand-secondary: var(--color-hostaway-secondary-100);
    --background-color-brand-solid: var(--color-gray-900);
    --background-color-brand-solid_hover: var(--color-gray-950);
    --background-color-brand-section: var(--color-gray-800);
    --background-color-brand-section_subtle: var(--color-gray-700);
    ...
    --background-color-error-solid_hover: var(--color-error-700);
    ...
    --text-color-editor-icon-fg: var(--color-gray-400);
    --text-color-editor-icon-fg_active: var(--color-gray-500);
    --color-featured-icon-light-fg-brand: var(--color-hostaway-secondary-600);
    ...
    --color-icon-fg-brand: var(--color-gray-600);
    --color-icon-fg-brand_on-brand: var(--color-gray-200);
    --color-slider-handle-border: var(--color-hostaway-secondary-600);
    --color-slider-handle-bg: var(--color-base-white);
    --color-screen-mockup-border: var(--color-gray-900);
    --color-footer-button-fg: var(--color-hostaway-secondary-200);
    --color-footer-button-fg_hover: var(--color-base-white);
    --color-app-store-badge-border: rgb(166, 166, 166);
    --color-toggle-button-fg-disabled: var(--color-gray-50);
    --color-toggle-border: var(--color-gray-300);
    --color-toggle-slim-border_pressed: var(--background-color-brand-solid);
    --color-toggle-slim-border_pressed_hover: var(--background-color-brand-solid_hover);
    ...
    --color-button-primary-icon: var(--color-gray-400);
    --color-button-primary-icon_hover: var(--color-gray-500);
    ...
    --color-focus-ring: var(--color-gray-500);
  ...
  --width-7xl: var(--container-7xl);
    ...
    /*
    --primitives-style-spacing-0--0px-: 0;
    ---primitives-style-spacing-0-5--2px-: 2;
    ---primitives-style-spacing-1--4px-: 4;
    ---primitives-style-spacing-2--8px-: 8;
    ---primitives-style-spacing-3--12px-: 12;
    ---primitives-style-spacing-4--16px-: 16;
    ---primitives-style-spacing-5--20px-: 20;
    ---primitives-style-spacing-6--24px-: 24;
    ---primitives-style-spacing-8--32px-: 32;
    ---primitives-style-spacing-10--40px-: 40;
    ---primitives-style-spacing-12--48px-: 48;
    ---primitives-style-spacing-16--64px-: 64;
    ---primitives-style-spacing-20--80px-: 80;
    ---primitives-style-spacing-24--96px-: 96;
    ---primitives-style-spacing-32--128px-: 128;
    ---primitives-style-spacing-40--160px-: 160;
    ---primitives-style-spacing-48--192px-: 192;
    ---primitives-style-spacing-56--224px-: 224;
    ---primitives-style-spacing-64--256px-: 256;
    ---primitives-style-spacing-96--384px-: 384;
    ---primitives-style-spacing-80--320px-: 320;
    ---primitives-style-spacing-120--480px-: 480;
    ---primitives-style-spacing-160--640px-: 640;
    ---primitives-style-spacing-192--768px-: 768;
    ---primitives-style-spacing-256--1-024px-: 1024;
    ---primitives-style-spacing-320--1-280px-: 1280;
    ---primitives-style-spacing-360--1-440px-: 1440;
    ---primitives-style-spacing-400--1-600px-: 1600;
    ---primitives-style-spacing-480--1-920px-: 1920;
    ---primitives-style-spacing-1-5--6px-: 6;
    ---primitives-style-spacing-140--560px-: 560;
    ---primitives-style-spacing-180--720px-: 720;
    */

    /* BACKGROUND PROPERTY COLORS */
    --color-quaternary: var(--background-color-quaternary);
    --color-brand-solid: var(--background-color-brand-solid);
    --color-disabled: var(--background-color-disabled);
    --color-primary: var(--background-color-primary);
    --color-primary-solid: var(--background-color-primary-solid);
    --color-primary_alt: var(--background-color-primary_alt);
    --color-primary_hover: var(--background-color-primary_hover);
    --color-secondary: var(--background-color-secondary);
    --color-secondary-solid: var(--background-color-secondary-solid);
    --color-secondary_alt: var(--background-color-secondary_alt);
    --color-secondary_hover: var(--background-color-secondary_hover);
    --color-secondary_subtle: var(--background-color-secondary_subtle);
    --color-tertiary: var(--background-color-tertiary);
    --color-active: var(--background-color-active);
    --color-disabled_subtle: var(--background-color-disabled_subtle);
    --color-overlay: var(--background-color-overlay);
    --color-brand-primary: var(--background-color-brand-primary);
    --color-brand-primary_alt: var(--background-color-brand-primary_alt);
    --color-brand-secondary: var(--background-color-brand-secondary);
    --color-brand-solid: var(--background-color-brand-solid);
    --color-brand-solid_hover: var(--background-color-brand-solid_hover);
    --color-brand-section: var(--background-color-brand-section);
    --color-brand-section_subtle: var(--background-color-brand-section_subtle);
    --color-error-primary: var(--background-color-error-primary);
    --color-error-secondary: var(--background-color-error-secondary);
    --color-error-solid: var(--background-color-error-solid);
    --color-warning-primary: var(--background-color-warning-primary);
    --color-warning-secondary: var(--background-color-warning-secondary);
    --color-warning-solid: var(--background-color-warning-solid);
    --color-success-primary: var(--background-color-success-primary);
    --color-success-secondary: var(--background-color-success-secondary);
    --color-success-solid: var(--background-color-success-solid);

    /* BORDER PROPERTY COLORS */
    --border-color-primary: var(--color-gray-300);
    --border-color-secondary: var(--color-gray-200);
    --border-color-secondary_alt: rgba(0, 0, 0, 0.078);
    --border-color-tertiary: var(--color-gray-100);
    --border-color-disabled: var(--color-gray-300);
    --border-color-disabled_subtle: var(--color-gray-200);
    --border-color-brand: var(--color-hostaway-secondary-500);
    --border-color-brand_alt: var(--color-hostaway-secondary-600);
    --border-color-brand-solid: var(--background-color-brand-solid);
    --border-color-brand-solid_hover: var(--background-color-brand-solid_hover);
    --border-color-error: var(--color-error-500);
    --border-color-disabled_subtle: var(--color-gray-200);
    --border-color-error_subtle: var(--color-error-300);

    /* RING PROPERTY COLORS */
    --ring-color-bg-brand-solid: var(--background-color-brand-solid);
    --ring-color-primary: var(--border-color-primary);
    --ring-color-secondary: var(--border-color-secondary);
    --ring-color-secondary_alt: var(--border-color-secondary_alt);
    --ring-color-tertiary: var(--border-color-tertiary);
    --ring-color-disabled: var(--border-color-disabled);
    --ring-color-brand: var(--border-color-brand);
    --ring-color-brand-solid: var(--background-color-brand-solid);
    --ring-color-brand-solid_hover: var(--background-color-brand-solid_hover);
    --ring-color-error: var(--border-color-error);
    --ring-color-disabled_subtle: var(--border-color-disabled_subtle);
    --ring-color-brand_alt: var(--border-color-brand_alt);
    --ring-color-error_subtle: var(--border-color-error_subtle);

    /* OUTLINE PROPERTY COLORS */
    --outline-color-brand: var(--border-color-brand);
    --outline-color-primary: var(--border-color-primary);
    --outline-color-secondary: var(--border-color-secondary);
    --outline-color-secondary_alt: var(--border-color-secondary_alt);
    --outline-color-tertiary: var(--border-color-tertiary);
    --outline-color-disabled: var(--border-color-disabled);
    --outline-color-brand: var(--border-color-brand);
    --outline-color-brand-solid: var(--background-color-brand-solid);
    --outline-color-brand-solid_hover: var(--background-color-brand-solid_hover);
    --outline-color-error: var(--border-color-error);
    --outline-color-disabled_subtle: var(--border-color-disabled_subtle);
    --outline-color-brand_alt: var(--border-color-brand_alt);
    --outline-color-error_subtle: var(--border-color-error_subtle);
}